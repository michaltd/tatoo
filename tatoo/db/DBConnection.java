...
public abstract class DBConnection {
    ...
    public enum DBases {
        ...
        /**
         * Gibt zurück wo die Verbindung zur Datenstruktur aufgebaut werden
         * kann.
         * 
    ...
    public final boolean write (Dataset o) {
        ...
        // ... dazu zunächst prüfen ob die ID des objektes > 0 ist. Wenn die id
        // == 0
        // ist das objekt neu
    ...
    /**
     * Führt die Migrationen bis zur übergebenen Version durch. Dabei kann es
     * sich entweder um eine kleinere als die derzeitige Version handeln, oder
     * um eine größere.
     * 
     * @param toVersion
    ...
    public void migrate (VersionNumber toVersion) {
        ...
        if (dbVersion.compareTo (toVersion) > 0) {
            // alle migrationen entfernen die kleiner sind als die aktuelle
            // toVersion
    ...
    /**
     * Gibt eine Liste aller Migrationen aus dem Migrationen-Verzeichnis als
     * eine aufsteigend nach versionsnummer sortierte Liste von
     * {@link Migration} objekten zurück.
     * 
