...
public abstract class DBConnection {
    ...
    public enum DBases {
        ...
        /**
         * Liefert den Treiberstring zurück. Dieser wird für die Verbindung mit einer SQL-Datenbank benötigt, um den
         * Treiber zu laden.
         *
    ...
    /**
     * Schreibt das übergebene Objekt o in die darunter liegende Datenstruktur. Ein Objekt, welches sich bereits in der
     * Datenbank befindet, wird lediglich angepasst, alle anderen neu geschrieben. Datasets erhalten nach den
     * Schreibvorgang ihre ID.
     *
     * @param o Das Objekt das geschrieben werden soll.
    ...
    /**
     * Führt die Migrationen bis zur übergebenen Version durch. Dabei kann es sich entweder um eine kleinere als die
     * derzeitige Version handeln, oder um eine größere.
     *
     * @param toVersion Die Version auf die Migriert werden soll.
     */
    ...
    /**
     * Führt die Methode
     * <code>migration_up</code> der übergebenen Migrationen aus. Wenn eine der Migrationen eine Versionsnummer hat,
     * welche über der aktuellen Versionsnummer liegt, wird eine MigrationInvocationException ausgelöst.
     *
     * @param migrations Liste von auszuführenden Migrationen.
     */
    ...
    /**
     * Führt die Methode
     * <code>migration_down</code> der übergebenen Migrationen aus. Wenn eine der Migrationen eine Versionsnummer hat,
     * welche über der aktuellen Versionsnummer liegt, wird eine MigrationInvocationException ausgelöst.
     *
     * @param migrations Liste von auszuführenden Migrationen.
     */
    ...
    /**
     *
     * Gibt eine Liste aller Migrationen aus dem Migrationen-Verzeichnis als eine aufsteigend nach versionsnummer
     * sortierte Liste von {@link Migration} objekten zurück.
     *
