 ...
 * müssen diese mit down() wieder entfernt werden. Ein Beispiel könnte
...
public abstract class Migration implements Comparable <Migration> {
    ...
    /**
     * führt die Methode <code>down()</code> aus und löscht die Versionsnummer
     * aus der Datenstruktur.
     */
    // TODO: prüfen ob die migration überhaupt erlaubt ist. Beispiel: es sind
    // noch
    ...
    /**
     * führt die Methode <code>up()</code> aus und fügt die Versionsnummer in
     * die Datenstruktur ein.
     */
    // TODO: prüfen ob die migration überhaupt erlaubt ist. Beispiel: es sind
    // noch
    // Migrationen vor dieser durchzuführen
