...
/**
 * Abstrakte Oberklasse für Datendefinitionen (Datenbeschreibungssprache). Die
 * Klasse ist die Grundlage für das erstellen, löschen und verändern von
 * Datenstrukturen.
 * 
 * @author mkortz
 */
public abstract class DataDefinition extends DataHandler {
    ...
    /**
     * Der Name der Datenstruktur. In Datenbanksichtweise wäre dies der Name
     * einer Tabelle
     */
    protected String                     t_Name;
    /**
     * Nimmt die Datenfelder auf, welche von der Datenoperation betroffen sind.
     * Der Schlüssel enthält den Datenfeldname in der Datenstrukturen und der
     * Wert den Datenfeldtypen.
     */
    protected Hashtable <String, String> t_columns = new Hashtable <String, String> ();
    /**
     * Nimmt die Pimärschlüsseldefinitionen auf. Der Schlüssel enthält den
     * Datenfeldname in der Datenstrukturen und der Wert den Datenfeldtypen.
     */
    protected Hashtable <String, String> t_pk      = new Hashtable <String, String> ();

    /**
     * @param schema
     * Das Datenbankschema welches für die Datenoperation benutzt wird.
    ...
    /**
     * Fügt ein Datenfeld hinzu. Der übergebene String muss das folgende Format
     * besitzen: "name:typ". Hat er das nicht wird eine
     * {@link DataDefinitionException} ausgelöst. Gibt diese Datendefinition als
     * {@link DataHandler} zurück.
     * 
     * @param column
     * Der übergebene String muss das folgende Format besitzen: "name:typ".
    ...
    /**
     * Fügt mehrere Datenfelder hinzu. Die übergebenen String müssen das
     * folgende Format besitzen: "name:typ". Haben sie das nicht wird eine
     * {@link DataDefinitionException} ausgelöst. Gibt diese Datendefinition als
     * {@link DataHandler} zurück.
     * 
     * @param columns
    ...
    /**
     * Fügt der Datenstruktur einen Primärschlüssel hinzu. Primärschlüssel sind
     * Datenfelder, welche die einzelnen Datensätze in der Datenstruktur
     * identifizieren. Ein Primärschlüssel darf nicht in mehreren Datensätzen
     * einer Datenstruktur vorkommen.
     * 
     * @param string
     * Der übergebene String muss das folgende Format besitzen: "name:typ".
     * @return Das Objekt dieser DataDefinition
