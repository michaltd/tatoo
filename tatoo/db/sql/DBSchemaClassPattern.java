...
public class DBSchemaClassPattern extends DBSchemaPattern {
  ...
  /**
   * Enthält die Sets aus der Schemadatei. Der Schlüssel ist der
   * Attributname der Klasse. Der Wert das entsprechende
   * {@link DBSchemaSetPattern} dazu.
   */
   ...
   * @return Die Attribute als DBSchemaPropertyPattern. Gibt <code>null</code> zurück wenn das Attribut nicht gefunden werden kann.
   */
  ...
  /**
   * Gibt ein Set zurück.
   * @param name Der Name des Attributes welches vom Set repräsentiert wird.
   * @return Das gesuchte Set. Gibt <code>null</code> zurück wenn das Set nicht gefunden werden kann.
   */
  ...
  /**
   * Gibt alle Sets zurück welche für die Klasse in der Schemadatei angegeben sind.
   * @return Die Sets als Liste aus DBSchemaSetPattern. Gibt <code>null</code> zurück wenn das Set nicht gefunden wird.
   */
