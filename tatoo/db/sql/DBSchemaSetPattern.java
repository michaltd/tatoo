...
/**
 * Abbildung des Set-Elements aus der Schemadatei. Ein Set bildet 1:n oder n:m Assoziationen auf Tabellen ab.
 * 
 * @author mkortz
 * 
 */
public class DBSchemaSetPattern extends DBSchemaPattern {
   ...
   * @param el Das XML-Element aus dem die Set-Schablone instaniiert wird.
   */
  ...
  /**
   * Gibt den Typ des Attributes zurück in welchem die Objekte gespeichert sind.
  ...
  /**
   * Gibt den Inhalt des Attributes des Datasets als ein Array aus Objekten zurück.
   * 
   ...
   */
  public Object[] getContent(Class<?> c, Dataset ds) throws SecurityException,
