...
/**
 * Abbildung des Propety-Elements aus der Schemadatei. Eine Property entspricht
 * einen einfachen Attribut (Keine 1:n Assoziationen)
 * 
 * @author mkortz
 */
public class DBSchemaPropertyPattern extends DBSchemaPattern {
     ...
     * 
     * @param el
     * Das XML-Element aus dem die Schablone instantiiert wird.
     */
    ...
    /**
     * Gibt den Namen der Spalte zurück welche das Attribut der Klasse
     * repräsentiert.
     * 
     ...
     * 
     * @param c
     * Die Klasse in welchem das Attribut definiert ist.
     * @param o
     * Das Objekt aus dem der Wert geholt werden soll.
     ...
     */
    public Object getValue (Class <?> c, Object o) throws SecurityException, NoSuchFieldException,
