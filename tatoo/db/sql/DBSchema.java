...
public class DBSchema {
    ...
    /**
     * Enthält die Tabellen als {@link DBSchemaPattern} mit dem Namen als
     * Schlüssel.
     */
    HashMap <String, DBSchemaPattern> schema = new HashMap <String, DBSchemaPattern> ();

    public DBSchema (InputStream pathToSchema) {
        Document doc = null;
        try {
            SAXBuilder builder = new SAXBuilder ();
            doc = builder.build (pathToSchema);
        }
        catch (Exception ex) {
            ex.printStackTrace ();
        }
     ...
     * Wenn die Klasse nicht im Schema gefunden wird, wird <code>null</code>
     * zurückgegeben.
     * 
     * @param cl
     * Die Klasse zu welcher der Tabellenname geholt werden soll
    ...
    /**
     * Gibt für die übergebene Klasse die <code>DBSchemaPattern</code> zurück.
     * Ist für die KLasse keine Definition vorhanden wird <code>null</code>
     * zurückgegeben.
     * 
     * @param cl
