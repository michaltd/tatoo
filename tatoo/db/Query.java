...
public abstract class Query extends DataHandler {
     ...
     * 
     * @param cl
     * die Klasse für die ein Objekt aus der Datenbank gelesen werden soll.
     ...
     * 
     * @param condition
     * Der String muss in der Form "name=bedingung" vorliegen. z.B. dataset_id=5
     ...
     * 
     * @param group
     * Der String muss als Komma-Separierte Liste übergeben werden, so wie er
     * auch in eine SQL-Anweisung auftauchen würde.
     * @return Ein Objekt dieser Abfrage.
     */
