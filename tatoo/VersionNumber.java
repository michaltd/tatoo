 ...
 * Verschiedene Versionsnummern sind untereinander Vergleichbar.
 * 
 * @author mkortz
 *
 */
public class VersionNumber extends Dataset implements Comparable<VersionNumber>{
	 ...
	 * Do NOT use!
	 */
//leerer Konstruktor. Ist für das Instanziieren aus dem Datenbankframework. NICHT löschen.
	@Deprecated 
	...
	/**
	 * Gibt die Versionsnummer als int Wert zurück. Der Wert entspricht der Versionsnummer ohne trennende Punkte.
