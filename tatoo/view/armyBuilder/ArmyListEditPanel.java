...
public abstract class ArmyListEditPanel extends JPanel implements
    EntityModelListener {

  protected int width = 300;
  protected EntityModel model = null;

  public ArmyListEditPanel(EntityModel entityModel) {
    super();
  ...
  public void AttribChanged(EntityModelEvent e) {
    // we ignore the event-Object here and refresh all attributes for simplicity 
    showValues();
  }
