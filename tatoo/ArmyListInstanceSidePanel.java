...
public class ArmyListInstanceSidePanel {
    ...
    // private ArmyListEntity andUpgrade(){ return new
    // AnyOfEntity("beliebiges aus"); }
    ...
    private AbstractEntity generateManually() {
        ...
        AbstractEntity andUpgrade3 = anyOfUpgrade();
        ...
        AbstractEntity andUpgrade4 = anyOfUpgrade();
        ...
        AbstractEntity andUpgrade2 = anyOfUpgrade();
