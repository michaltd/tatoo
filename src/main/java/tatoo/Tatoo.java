...
public class Tatoo
{
     ...
     * Hauptfenster mittels {@link MainWindow#createAndShowGUI(VersionNumber)} auf.
     *
     * @param args
     */
...
//        dbfact = DBFactory.getInstance(configuration.getDatabase());
        dbfact = DBFactory.getInstance(DBConnection.DBases.H2Server);
     ...
     *
     * @throws Exception Wenn das Nimbus LAF nicht gesetzt werden kann wird diese Exception
     *                   geworfen.
     */
