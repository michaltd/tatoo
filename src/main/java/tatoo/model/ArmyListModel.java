...
public class ArmyListModel implements ArmyModel, EntityListener
{
    ...
    /**
     * Instantiiert einen neuen ArmyListEntity-Baum.
     */
     ...
     *
     * @param parent Der Knoten dessen Kindsknoten zurückgegeben werden soll.
     * @param index  Der index des Kindsknotens, der zurückgegeben werden soll.
     ...
     *
     * @param o Der Knoten dessen Pfad ermittelt werden soll.
     ...
     *
     * @param e          Das ArmyListEntity dessen Pfad zurückgegeben werden soll
     * @param levelCount die Baumtiefe in der sich der gesuchte Knoten befindet. Wird von außen
