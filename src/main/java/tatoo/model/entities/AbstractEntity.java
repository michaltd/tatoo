 ...
 * @author mkortz
 */
public abstract class AbstractEntity extends Dataset implements EntityBase, ConditionListener
{
    /**
     ...
     */
    private CalculatedNumber[] attributes = new CalculatedNumber[ConditionTypes.values().length];
    ...
    protected ArrayList<AbstractEntity> entities = new ArrayList<>();
    ...
    private void init()
    {
        ...
        for (int i = 0; i < ConditionTypes.values().length; i++) {
     ...
     * Klont dieses Entity.
     *
     * @param parent Der Elternknoten. Der Parent-Knoten wird für das klonen der Attribute des
     ...
     *
     * @param e Das Entity dessen Ursprung zurückgegeben werden soll
     ...
     *
     * @param l Der Listener, der hinzugefügt werden soll.
     */
     ...
     *
     * @param l der Listender, der entfernt werden soll.
     */
