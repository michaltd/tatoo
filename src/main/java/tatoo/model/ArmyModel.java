...
public interface ArmyModel extends TreeModel
{
     ...
     */
    AbstractEntity insertNewEntity(Object parent);
     ...
     */
    AbstractEntity insertCopyOf(Object[] treePath);
     ...
     */
    void removeNodeFromParent(Object node);
}
