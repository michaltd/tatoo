...
public class ArmyListEntityModel extends AbstractEntityModel
{
     ...
     *
     * @param o Das ArmyListEntity das von dem Model gekapselt werden soll.
     */
    ...
    {
        if (entity != null) {
            int realVal = entity.getAttribute(ConditionTypes.COUNT).getValue();
            int maxVal = entity.getAttribute(ConditionTypes.MAX_COUNT).getValue();
            int minVal = entity.getAttribute(ConditionTypes.MIN_COUNT).getValue();
     ...
     *
     * @param count Die neue Anzahl des Entitys.
     */
    public void setCount(int count)
    {
        if (entity.getAttribute(ConditionTypes.MIN_COUNT).getValue() <= count
            && entity.getAttribute(ConditionTypes.MAX_COUNT).getValue() >= count) {
    ...
    {
        if (entity != null)
            return entity.getAttribute(ConditionTypes.MAX_COUNT).getValue().toString();
        return null;
    }
     ...
     *
     * @param maxCount die Maximale Anzahl.
     */
    ...
    {
        if (entity != null)
            return entity.getAttribute(ConditionTypes.MIN_COUNT).getValue().toString();
        return null;
    }
     ...
     *
     * @param minCount die Minimale Anzahl.
     */
    ...
    {
        entity.setName(name);
        fireAttribChanged(new EntityModelEvent(entity, null));
    }
     ...
     *
     * @param o Das ArmyListEntity welches von dem Model gekapselt werden soll.
     */
