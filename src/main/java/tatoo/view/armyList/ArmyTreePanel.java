...
//        treePanel.setLayout (new BorderLayout ());
     ...
     *
     * @param node  Der Knoten für den das JPanel zusemmengestelltwerden soll.
     * @param panel Das Eltern-JPanel auf dem die Knoten dargestellt werden sollen.
     */
    public void buildPanel(Object node, JPanel panel, NodePanelFactory nodeFactory)
    {
        if (node != null)
            buildPanel(new ArrayList<>(), null, node, panel, nodeFactory);
    }
     ...
     * Methode.
     *
     * @param oneOfUpgradeModel TODO
     * @param parentPanel       das ElternPanel auf dem die Knoten dargestellt werden sollen.
     * @param node              Der darzustellende Knoten.
     * @param panel             Das Panel auf dem der übergebene Knoten dargestellt wird.
     * @param nodeFactory       Die Factory welche das Panel für den Knoten baut.
     */
